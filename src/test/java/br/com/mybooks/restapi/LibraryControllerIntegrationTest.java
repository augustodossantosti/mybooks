...
/**
 * A classe <code>LibraryControllerIntegrationTest</code> contém os
 * testes de integração para as operações de dominio da aplicação.
 *
 * @author Augusto dos Santos
 * @version 1.0 19 de abr de 2017
 */
@RunWith(SpringJUnit4ClassRunner.class)
public class LibraryControllerIntegrationTest extends AbstractIntegrationTest {
